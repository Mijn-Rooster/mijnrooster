...
get('/v1/school', 'Controllers/SchoolController.php'); // To be implemented
...
get('/v1/school/$schoolInSchoolYear/teacher/$teacherId', 'Controllers/TeacherController.php'); // To be implemented
